...
$("#save").click(function (event) {
    ...
    // Preenchendo o array de dados para requisi��o do formul�rio
    var dados = {
    ...
    if (!$('#mapa').is(":checked") && (!localidade || !especialista || !qtd_vagas
        ...
        swal("O preenchimento de todos os campos s�o obrigat�rios");
        ...
        swal("A quantidade de vaga dos mapas devem ser menor ou igual a quantidade de vagas total do m�dico para entendimento nesse dia!");
    } else {
        $.ajax({
            ...
            success: function (data) {
                swal('Cadastro realizado com sucesso!', "Click no bot�o abaixo!", 'success');
...
$("#edit").click(function (event) {
    ...
    if (!$('#mapa').is(":checked") && (!localidade || !especialista || !qtd_vagas
        ...
        $.ajax({
            ...
            type: "POST",
            success: function (data) {
                swal('Dia editado com sucesso!', "Click no bot�o abaixo!", 'success');
                location.href = "index.php/serbinario/calendario/index/" + idEspecialista;
            }
        });
    }
...
$(document).on('click', '#fechar', function (event) {
    ...
    swal({
        ...
        $.ajax({
            ...
            type: "GET",
            success: function (data) {
                swal('Dia fechado com sucesso!', "Click no bot�o abaixo!", 'success');
                location.href = "index.php/serbinario/calendario/index/" + idEspecialista;
            }
        });
    });
    ...
    if(descricao) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                swal('Dia bloqueado com sucesso!', "Click no bot�o abaixo!", 'success');
                location.href = "index.php/serbinario/calendario/index/" + idEspecialista;
            }
        });

    } else {
        swal('Informe o motivo do bloqueio!', "Click no bot�o abaixo!", 'success');
    }
