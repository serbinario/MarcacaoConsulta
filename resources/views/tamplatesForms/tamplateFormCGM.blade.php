...
<div class="card">
    <div class="card-body card-padding">
        ...
        <ul class="tab-nav" role="tablist">
            <li><a href="#dpessoais" aria-controls="dpessoais" role="tab" data-toggle="tab">Dados pessoais</a>
            </li>

            <li><a href="#doc" aria-controls="doc" role="tab" data-toggle="tab">Documentação</a>
            </li>

            <li><a href="#end" aria-controls="end" role="tab" data-toggle="tab">Endereço</a>
            </li>
        </ul>
        <!-- Tab panes -->
        <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="dpessoais">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-2">
                        <div class="fg-line">
                            ...
                            {!! Form::text('data_nascimento', Session::getOldInput('data_nascimento') , array('class' => 'form-control input-sm date-picker date', 'placeholder' => '')) !!}
                        </div>
                    </div>
                    <div class="form-group col-sm-2">
                        <div class=" fg-line">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-4">
                        <div class=" fg-line">
                            <label for="cgmmunicipio">Cidação do município?</label>
                            <div class="select">
                    ...
                    <div class="form-group col-sm-2">
                        <div class="fg-line">
                            ...
                            {!! Form::text('data_falecimento', Session::getOldInput('data_falecimento') , array('class' => 'form-control input-sm date-picker date', 'placeholder' => '')) !!}
                        </div>
                    </div>
                    <div class="form-group col-sm-4">
                        <div class=" fg-line">
                ...
                <div class="row">
                    <div class="form-group col-sm-2">
                        <div class=" fg-line">
                            ...
                            {!! Form::text('cpf_cnpj', Session::getOldInput('cpf_cnpj') , array('class' => 'form-control input-sm', 'placeholder' => '')) !!}
                        </div>
                    </div>
                    <div class="form-group col-sm-2">
                        <div class=" fg-line">
                    ...
                    <div class="form-group col-sm-2">
                        <div class=" fg-line">
                            ...
                            {!! Form::text('data_expedicao', Session::getOldInput('data_expedicao') , array('class' => 'form-control date-picker date', 'placeholder' => '')) !!}
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-2">
                        <div class=" fg-line">
                            ...
                            {!! Form::text('endereco[cep]', Session::getOldInput('endereco[cep]') , array('class' => 'form-control input-sm', 'placeholder' => '')) !!}
                        </div>
                    </div>
