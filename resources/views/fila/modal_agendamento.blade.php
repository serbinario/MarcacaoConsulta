...
<div id="modal-agendamento" class="modal fade modal-profile" role="dialog" aria-labelledby="modalProfile" aria-hidden="true">
    <div class="modal-dialog modal-lg" style="width: 90%">
        <div class="modal-content">
            <div class="modal-header">
                <button class="close" type="button" data-dismiss="modal">×</button>
                <h4 class="modal-title">Agendar Pacientes</h4>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-12" style="background-color: #e6e9dc">
                                ...
                                <div class="col-md-4" style="margin-top: 17px">
                                    <span><strong>Pacientes a serem agendados: </strong><p class="qtdPacientes"></p></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row" style="margin-top: -2%; margin-bottom: 3%;">
                            <div class="form-group col-md-2">
                                <div class=" fg-line">
                                    ...
                                    <div class="select">
                                        {!! Form::select("especialista", array(), null, array('class'=> 'form-control', 'id' => 'especialista')) !!}
                                        <input type="hidden" name="especialidade" value="" id="especialidade-agendar">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-2">
                                <div class=" fg-line">
                                    ...
                                    <div class="select">
                                        {!! Form::select("calendario", array(), null, array('class'=> 'form-control', 'id' => 'calendario-agendar')) !!}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-2">
                                <div class=" fg-line">
                                    ...
                                    <div class="select">
                                        {!! Form::select("mapa", array(), null, array('class'=> 'form-control', 'id' => 'mapa-agendar')) !!}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-2">
                                <div class="fg-line" style="margin-top: 20px">
                                    <div class="fg-line">
                                        <button type="button" id="agendar" class="btn btn-primary btn-sm m-t-10">Agendar</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row msg">
                            <p style="color: red; margin-top: -30px">* A quantidade de vagas disponíveis no MAPA selecioando é
                                inferior a quantidade de pacientes selecionados para agendamento.</p>
                        </div>
